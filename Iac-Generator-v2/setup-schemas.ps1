...
Write-Host "`n[3/4] Downloading GCP Discovery Index..." -ForegroundColor Yellow
Invoke-WebRequest -Uri "https://www.googleapis.com/discovery/v1/apis" -OutFile "$dbFolder\google-apis-index.json" -UseBasicParsing
Write-Host "      -> GCP index downloaded successfully." -ForegroundColor Green
