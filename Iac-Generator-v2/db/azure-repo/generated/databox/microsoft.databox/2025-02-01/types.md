# Microsoft.DataBox @ 2025-02-01

## Resource Microsoft.DataBox/jobs@2025-02-01
...
## Function listCredentials (Microsoft.DataBox/jobs@2025-02-01)
...
* **errorCode**: 'ActiveOrderLimitBreachedDelay' | 'HighDemandDelay' | 'InternalIssueDelay' | 'LargeNumberOfFilesDelay' | string (ReadOnly): Delay Error code
...
* **dataCenterCode**: 'AM2' | 'AMS06' | 'AMS20' | 'AMS25' | 'AUH20' | 'AdHoc' | 'BJB' | 'BJS20' | 'BL20' | 'BL24' | 'BL7' | 'BN1' | 'BN7' | 'BOM01' | 'BY1' | 'BY2' | 'BY21' | 'BY24' | 'CBR20' | 'CH1' | 'CPQ02' | 'CPQ20' | 'CPQ21' | 'CWL20' | 'CYS04' | 'DSM05' | 'DSM11' | 'DUB07' | 'DXB23' | 'FRA22' | 'HKG20' | 'IDC5' | 'Invalid' | 'JNB21' | 'JNB22' | 'LON24' | 'MAA01' | 'MEL23' | 'MNZ21' | 'MWH01' | 'NTG20' | 'ORK70' | 'OSA02' | 'OSA20' | 'OSA22' | 'OSA23' | 'PAR22' | 'PNQ01' | 'PUS20' | 'SEL20' | 'SEL21' | 'SG2' | 'SHA03' | 'SIN20' | 'SN5' | 'SN6' | 'SN8' | 'SSE90' | 'SVG20' | 'SYD03' | 'SYD23' | 'TYO01' | 'TYO22' | 'TYO23' | 'YQB20' | 'YTO20' | 'YTO21' | 'ZRH20' | string (ReadOnly): DataCenter code.
...
## JobProperties
### Properties
* **allDevicesLost**: bool (ReadOnly): Flag to indicate if all devices associated with the job are lost.
...
* **model**: 'AzureDataBox120' | 'AzureDataBox525' | 'DataBox' | 'DataBoxCustomerDisk' | 'DataBoxDisk' | 'DataBoxHeavy': The customer friendly name of the combination of version and capacity of the device. This field is necessary only at the time of ordering the newer generation device i.e. AzureDataBox120 and AzureDataBox525 as of Feb/2025
