...
## Resource Microsoft.Sql/locations/usages@2015-05-01-preview
...
## Resource Microsoft.Sql/servers/advisors@2015-05-01-preview
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: None
### Properties
* **apiVersion**: '2015-05-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.Sql/servers/databases/advisors@2015-05-01-preview
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: None
### Properties
* **apiVersion**: '2015-05-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.Sql/servers/databases/advisors/recommendedActions@2015-05-01-preview
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: None
### Properties
* **apiVersion**: '2015-05-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
* **properties**: [DatabaseBlobAuditingPolicyPropertiesAutoGenerated](#databaseblobauditingpolicypropertiesautogenerated): Resource properties.
* **type**: 'Microsoft.Sql/servers/databases/auditingSettings' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.Sql/servers/databases/automaticTuning@2015-05-01-preview
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: None
### Properties
* **apiVersion**: '2015-05-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.Sql/virtualClusters@2015-05-01-preview
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: None
### Properties
* **apiVersion**: '2015-05-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## DatabaseBlobAuditingPolicyPropertiesAutoGenerated
### Properties
* **auditActionsAndGroups**: string[]: Specifies the Actions and Actions-Groups to audit.
* **isStorageSecondaryKeyInUse**: bool: Specifies whether storageAccountAccessKey value is the storage’s secondary key.
* **retentionDays**: int: Specifies the number of days to keep in the audit logs.
* **state**: 'Disabled' | 'Enabled' (Required): Specifies the state of the policy. If state is Enabled, storageEndpoint and storageAccountAccessKey are required.
* **storageAccountAccessKey**: string (WriteOnly): Specifies the identifier key of the auditing storage account. If state is Enabled, storageAccountAccessKey is required.
