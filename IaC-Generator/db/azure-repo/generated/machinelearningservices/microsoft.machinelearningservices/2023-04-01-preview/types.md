...
## Resource Microsoft.MachineLearningServices/workspaces/featuresets/versions/features@2023-04-01-preview
* **Readable Scope(s)**: ResourceGroup
...
* **computeId**: string {minLength: 1, pattern: "[a-zA-Z0-9_]"} (Required): [Required] The ARM resource ID of the compute resource to run the monitoring job on.
