# Microsoft.Security @ 2025-03-01

## Resource Microsoft.Security/securityConnectors/devops@2025-03-01
...
## Resource Microsoft.Security/securityConnectors/devops/azureDevOpsOrgs@2025-03-01
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-03-01' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.Security/securityConnectors/devops/azureDevOpsOrgs/projects@2025-03-01
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-03-01' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.Security/securityConnectors/devops/azureDevOpsOrgs/projects/repos@2025-03-01
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2025-03-01' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.Security/securityConnectors/devops/gitHubOwners@2025-03-01
* **Readable Scope(s)**: ResourceGroup
...
## Resource Microsoft.Security/securityConnectors/devops/gitHubOwners/repos@2025-03-01
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: None
### Properties
* **apiVersion**: '2025-03-01' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.Security/securityConnectors/devops/gitLabGroups@2025-03-01
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: None
### Properties
* **apiVersion**: '2025-03-01' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.Security/securityConnectors/devops/gitLabGroups/projects@2025-03-01
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: None
### Properties
* **apiVersion**: '2025-03-01' (ReadOnly, DeployTimeConstant): The resource api version
...
## Function listAvailableAzureDevOpsOrgs (Microsoft.Security/securityConnectors/devops@2025-03-01)
* **Resource**: Microsoft.Security/securityConnectors/devops
* **ApiVersion**: 2025-03-01
* **Output**: [AzureDevOpsOrgListResponse](#azuredevopsorglistresponse)

## Function listAvailableGitHubOwners (Microsoft.Security/securityConnectors/devops@2025-03-01)
* **Resource**: Microsoft.Security/securityConnectors/devops
* **ApiVersion**: 2025-03-01
* **Output**: [GitHubOwnerListResponse](#githubownerlistresponse)

## Function listAvailableGitLabGroups (Microsoft.Security/securityConnectors/devops@2025-03-01)
* **Resource**: Microsoft.Security/securityConnectors/devops
* **ApiVersion**: 2025-03-01
* **Output**: [GitLabGroupListResponse](#gitlabgrouplistresponse)

## Function listSubgroups (Microsoft.Security/securityConnectors/devops/gitLabGroups@2025-03-01)
...
### Properties
* **agentlessAutoDiscovery**: 'Disabled' | 'Enabled' | 'NotApplicable' | string: AutoDiscovery states.
* **agentlessEnabled**: 'Disabled' | 'Enabled' | 'NotApplicable' | string: Agentless Enablement states.
* **inventoryList**: [InventoryList](#inventorylist)[]: Gets or sets the inventory list for inclusion or exclusion from Agentless.
Will be ignored if agentless auto-discovery is enabled.
* **inventoryListType**: 'Exclusion' | 'Inclusion' | string: Types for inventory list.
* **scanners**: string[]: Gets or sets the scanners for the connector.
...
### Properties
* **agentlessConfiguration**: [AgentlessConfiguration](#agentlessconfiguration): Details about Agentless configuration.
